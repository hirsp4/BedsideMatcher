...
@implementation getPreparedPrescriptionsForPatient
@synthesize arg0;

+ (getPreparedPrescriptionsForPatient *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
