...
@implementation getPreparedPrescriptionsForPatientResponse

@synthesize items;

+ (getPreparedPrescriptionsForPatientResponse *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
+ (id)array {
	return [[ getPreparedPrescriptionsForPatientResponse alloc] init];
}

+ (id)arrayWithObject:(trspPrescription*)anObject {
	return [[ getPreparedPrescriptionsForPatientResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const trspPrescription* *)objects count:(NSUInteger)cnt {
	return [[ getPreparedPrescriptionsForPatientResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(trspPrescription*)firstObj, ... {
	getPreparedPrescriptionsForPatientResponse* a = [ getPreparedPrescriptionsForPatientResponse array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ getPreparedPrescriptionsForPatientResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ getPreparedPrescriptionsForPatientResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ getPreparedPrescriptionsForPatientResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ getPreparedPrescriptionsForPatientResponse alloc] initWithCapacity:numItems];
}
