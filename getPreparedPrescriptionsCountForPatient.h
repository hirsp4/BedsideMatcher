...
@interface getPreparedPrescriptionsCountForPatient : NSObject <ISerializableObject>
...
+(getPreparedPrescriptionsCountForPatient*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
