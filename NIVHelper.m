...
{
    DDXMLNode* child=[NIVHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[NIVHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[NIVHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
