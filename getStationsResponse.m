...
@implementation getStationsResponse

@synthesize items;

+ (getStationsResponse *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(station*)[__request createObject:child type:[station class]]];
        }
...
{
    for (station* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[station class] name:@"return" URI:@"" parent:__parent skipNullProperty:NO];
...
- (station*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(station*)anObject {
...
- (BOOL)containsObject:(station*)anObject {
...
- (NSUInteger)indexOfObject:(station*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(station*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(station*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(station*)anObject inRange:(NSRange)range {
...
- (void)addObject:(station*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(station*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(station*)anObject {
...
- (void)removeObject:(station*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(station*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(station*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(station*)anObject {
...
+ (id)array {
	return [[ getStationsResponse alloc] init];
}

+ (id)arrayWithObject:(station*)anObject {
	return [[ getStationsResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const station* *)objects count:(NSUInteger)cnt {
	return [[ getStationsResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(station*)firstObj, ... {
	getStationsResponse* a = [ getStationsResponse array];
	id eachObject;
...
- (id)initWithObjects:(station*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ getStationsResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ getStationsResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ getStationsResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ getStationsResponse alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const station* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(station*, station*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(station*, station*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(station*, station*, void *))compare context:(void *)context {
