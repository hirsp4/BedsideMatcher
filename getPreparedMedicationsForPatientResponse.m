...
@implementation getPreparedMedicationsForPatientResponse
...
-(void) serialize:(DDXMLElement*)__parent __request:(RequestResultHandler*) __request
{
    for (trspPreparedMedication* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[trspPreparedMedication class] name:@"return" URI:@"" parent:__parent skipNullProperty:NO];
...
+ (id)array {
	return [[ getPreparedMedicationsForPatientResponse alloc] init];
}

+ (id)arrayWithObject:(trspPreparedMedication*)anObject {
	return [[ getPreparedMedicationsForPatientResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const trspPreparedMedication* *)objects count:(NSUInteger)cnt {
	return [[ getPreparedMedicationsForPatientResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(trspPreparedMedication*)firstObj, ... {
	getPreparedMedicationsForPatientResponse* a = [ getPreparedMedicationsForPatientResponse array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ getPreparedMedicationsForPatientResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ getPreparedMedicationsForPatientResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ getPreparedMedicationsForPatientResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ getPreparedMedicationsForPatientResponse alloc] initWithCapacity:numItems];
}
