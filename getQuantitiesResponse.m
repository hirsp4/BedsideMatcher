...
@implementation getQuantitiesResponse

@synthesize items;

+ (getQuantitiesResponse *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(quantity*)[__request createObject:child type:[quantity class]]];
        }
...
{
    for (quantity* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[quantity class] name:@"return" URI:@"" parent:__parent skipNullProperty:NO];
...
- (quantity*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(quantity*)anObject {
...
- (BOOL)containsObject:(quantity*)anObject {
...
- (NSUInteger)indexOfObject:(quantity*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(quantity*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(quantity*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(quantity*)anObject inRange:(NSRange)range {
...
- (void)addObject:(quantity*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(quantity*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(quantity*)anObject {
...
- (void)removeObject:(quantity*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(quantity*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(quantity*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(quantity*)anObject {
...
+ (id)array {
	return [[ getQuantitiesResponse alloc] init];
}

+ (id)arrayWithObject:(quantity*)anObject {
	return [[ getQuantitiesResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const quantity* *)objects count:(NSUInteger)cnt {
	return [[ getQuantitiesResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(quantity*)firstObj, ... {
	getQuantitiesResponse* a = [ getQuantitiesResponse array];
	id eachObject;
...
- (id)initWithObjects:(quantity*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ getQuantitiesResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ getQuantitiesResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ getQuantitiesResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ getQuantitiesResponse alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const quantity* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(quantity*, quantity*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(quantity*, quantity*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(quantity*, quantity*, void *))compare context:(void *)context {
