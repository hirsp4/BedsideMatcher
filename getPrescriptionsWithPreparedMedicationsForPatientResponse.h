...
@interface getPrescriptionsWithPreparedMedicationsForPatientResponse : NSObject < NSCopying, NSMutableCopying, NSCoding, NSFastEnumeration>
...
+ (id)arrayWithObjects:(trspPrescription*)firstObj, ... NS_REQUIRES_NIL_TERMINATION;
+ (id)arrayWithArray:(NSArray *)array;

- (id)initWithObjects:(const trspPrescription* *)objects count:(NSUInteger)cnt;
- (id)initWithObjects:(trspPrescription*)firstObj, ... NS_REQUIRES_NIL_TERMINATION;
