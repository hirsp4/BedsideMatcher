...
@interface getPrescriptionsWithPreparedMedicationsForPatient : NSObject <ISerializableObject>
...
+(getPrescriptionsWithPreparedMedicationsForPatient*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
