...
@interface getDosetForPatient : NSObject <ISerializableObject>
...
+(getDosetForPatient*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
