...
@implementation getPatientsResponse

@synthesize items;

+ (getPatientsResponse *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(trspPatient*)[__request createObject:child type:[trspPatient class]]];
        }
...
{
    for (trspPatient* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[trspPatient class] name:@"return" URI:@"" parent:__parent skipNullProperty:NO];
...
- (trspPatient*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(trspPatient*)anObject {
...
- (BOOL)containsObject:(trspPatient*)anObject {
...
- (NSUInteger)indexOfObject:(trspPatient*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(trspPatient*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(trspPatient*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(trspPatient*)anObject inRange:(NSRange)range {
...
- (void)addObject:(trspPatient*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(trspPatient*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(trspPatient*)anObject {
...
- (void)removeObject:(trspPatient*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(trspPatient*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(trspPatient*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(trspPatient*)anObject {
...
+ (id)array {
	return [[ getPatientsResponse alloc] init];
}

+ (id)arrayWithObject:(trspPatient*)anObject {
	return [[ getPatientsResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const trspPatient* *)objects count:(NSUInteger)cnt {
	return [[ getPatientsResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(trspPatient*)firstObj, ... {
	getPatientsResponse* a = [ getPatientsResponse array];
	id eachObject;
...
- (id)initWithObjects:(trspPatient*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ getPatientsResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ getPatientsResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ getPatientsResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ getPatientsResponse alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const trspPatient* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(trspPatient*, trspPatient*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(trspPatient*, trspPatient*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(trspPatient*, trspPatient*, void *))compare context:(void *)context {
