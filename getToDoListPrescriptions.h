...
@interface getToDoListPrescriptions : NSObject <ISerializableObject>

-(id)init;
-(id)initWithXml: (DDXMLElement*)__node __request:(RequestResultHandler*) __request;
+(getToDoListPrescriptions*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
