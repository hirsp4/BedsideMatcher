...
@interface getProductForSecondaryPackageResponse : NSObject <ISerializableObject>
...
+(getProductForSecondaryPackageResponse*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
