...
#import "updateDispensedMedicationResponse.h"
#import "sayHelloWorldFrom.h"
#import "sayHelloWorldFromResponse.h"
#import "getPreparedPrescriptionsForPatient.h"
...
-(id)init:(int)version {
    if ((self=[super init])) {
        ...
        if(!classNames)
        {
            ...
            [updateDispensedMedication class],@"http://service/^^updateDispensedMedication",
            [updateDispensedMedicationResponse class],@"http://service/^^updateDispensedMedicationResponse",
            ...
            [getPreparedPrescriptionsForPatient class],@"http://service/^^getPreparedPrescriptionsForPatient",
            ...
            [getPreparedPrescriptionsForPatientResponse class],@"http://service/^^getPreparedPrescriptionsForPatientResponse",
