...
@implementation NIVgetItemsBySSCCResponse
...
- (id) initWithXml: (DDXMLElement*) __node __request:(NIVRequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(NIVitem*)[__request createObject:child type:[NIVitem class]]];
        }
...
{
    for (NIVitem* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[NIVitem class] name:@"return" URI:@"" parent:__parent skipNullProperty:NO];
...
- (void)removeObjectIdenticalTo:(NIVitem*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(NIVitem*)anObject {
...
+ (id)array {
	return [[ NIVgetItemsBySSCCResponse alloc] init];
}

+ (id)arrayWithObject:(NIVitem*)anObject {
	return [[ NIVgetItemsBySSCCResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const NIVitem* *)objects count:(NSUInteger)cnt {
	return [[ NIVgetItemsBySSCCResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(NIVitem*)firstObj, ... {
	NIVgetItemsBySSCCResponse* a = [ NIVgetItemsBySSCCResponse array];
	id eachObject;
...
- (id)initWithObjects:(NIVitem*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ NIVgetItemsBySSCCResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ NIVgetItemsBySSCCResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ NIVgetItemsBySSCCResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ NIVgetItemsBySSCCResponse alloc] initWithCapacity:numItems];
}
