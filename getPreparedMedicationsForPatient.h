...
@interface getPreparedMedicationsForPatient : NSObject <ISerializableObject>
...
+(getPreparedMedicationsForPatient*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
