...
@interface getLogisticUnitsForProduct : NSObject <ISerializableObject>
...
+(getLogisticUnitsForProduct*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
