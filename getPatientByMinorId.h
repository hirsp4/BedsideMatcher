...
@interface getPatientByMinorId : NSObject <ISerializableObject>
...
+(getPatientByMinorId*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
