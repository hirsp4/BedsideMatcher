...
@implementation getPrescriptionsWithPreparedMedicationsForPatientResponse

@synthesize items;

+ (getPrescriptionsWithPreparedMedicationsForPatientResponse *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
+ (id)array {
	return [[ getPrescriptionsWithPreparedMedicationsForPatientResponse alloc] init];
}

+ (id)arrayWithObject:(trspPrescription*)anObject {
	return [[ getPrescriptionsWithPreparedMedicationsForPatientResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const trspPrescription* *)objects count:(NSUInteger)cnt {
	return [[ getPrescriptionsWithPreparedMedicationsForPatientResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(trspPrescription*)firstObj, ... {
	getPrescriptionsWithPreparedMedicationsForPatientResponse* a = [ getPrescriptionsWithPreparedMedicationsForPatientResponse array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ getPrescriptionsWithPreparedMedicationsForPatientResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ getPrescriptionsWithPreparedMedicationsForPatientResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ getPrescriptionsWithPreparedMedicationsForPatientResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ getPrescriptionsWithPreparedMedicationsForPatientResponse alloc] initWithCapacity:numItems];
}
