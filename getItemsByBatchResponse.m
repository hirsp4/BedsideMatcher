...
@implementation getItemsByBatchResponse

@synthesize items;

+ (getItemsByBatchResponse *)createWithXml:(DDXMLElement *)__node __request:(RequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(RequestResultHandler*) __request {
    if(self = [self init])
    {
        ...
        {
            [self.items addObject:(item*)[__request createObject:child type:[item class]]];
        }
...
-(void) serialize:(DDXMLElement*)__parent __request:(RequestResultHandler*) __request
{
    for (item* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[item class] name:@"return" URI:@"" parent:__parent skipNullProperty:NO];
...
- (void)removeObjectIdenticalTo:(item*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(item*)anObject {
...
+ (id)array {
	return [[ getItemsByBatchResponse alloc] init];
}

+ (id)arrayWithObject:(item*)anObject {
	return [[ getItemsByBatchResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const item* *)objects count:(NSUInteger)cnt {
	return [[ getItemsByBatchResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(item*)firstObj, ... {
	getItemsByBatchResponse* a = [ getItemsByBatchResponse array];
	id eachObject;
...
- (id)initWithObjects:(item*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ getItemsByBatchResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ getItemsByBatchResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ getItemsByBatchResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ getItemsByBatchResponse alloc] initWithCapacity:numItems];
}
