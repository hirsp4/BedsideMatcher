...
@implementation getItemsBySSCCResponse
...
+ (id)array {
	return [[ getItemsBySSCCResponse alloc] init];
}

+ (id)arrayWithObject:(item*)anObject {
	return [[ getItemsBySSCCResponse alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const item* *)objects count:(NSUInteger)cnt {
	return [[ getItemsBySSCCResponse alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(item*)firstObj, ... {
	getItemsBySSCCResponse* a = [ getItemsBySSCCResponse array];
	id eachObject;
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ getItemsBySSCCResponse alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ getItemsBySSCCResponse alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ getItemsBySSCCResponse alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ getItemsBySSCCResponse alloc] initWithCapacity:numItems];
}
