...
-(RequestResultHandler*) updatePreparedMedicationsAsync:(updatePreparedMedications*) updatePreparedMedications __target:(id) __target __handler:(SEL) __handler
{
    ...
    {
        DDXMLElement *__mainReturn=(DDXMLElement*)[__request.OutputBody childAtIndex:0];
        __res= (mediPrepResult*)[__request createObject:__mainReturn type:[mediPrepResult class]];
    }
    else
    {
        __res=__requestMgr.OutputFault;
...
-(RequestResultHandler*) updatePreparedMedicationsAsync:(updatePreparedMedications*) updatePreparedMedications __target:(id<SoapServiceResponse>) __target
{
    ...
    {
        DDXMLElement *__mainReturn=(DDXMLElement*)[__request.OutputBody childAtIndex:0];
        [__target onSuccess:(mediPrepResult*)[__request createObject:__mainReturn type:[mediPrepResult class]] methodName:@"updatePreparedMedications"];
    }
    else
    {
        [__target onError:__requestMgr.OutputFault];
...
-(mediPrepResult*) updatePreparedMedications:(updatePreparedMedications*) updatePreparedMedications __error:(NSError**) __error
{
    ...
    DDXMLElement *__mainReturn=(DDXMLElement*)[__request.OutputBody childAtIndex:0];
    return (mediPrepResult*)[__request createObject:__mainReturn type:[mediPrepResult class]];
}
...
{
    RequestResultHandler* __request = [self CreateRequestResultHandler];
    NSMutableURLRequest *__requestObj=[self creategetLogisticUnitsForProductRequest:arg0 __request:__request];
    [self sendImplementation:__requestObj requestMgr:__request callback:^(RequestResultHandler *__requestMgr) {
    id __res;
    if(__requestMgr.OutputFault==nil)
    {
        DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"getLogisticUnitsForProductResponse"];
        __res= (getLogisticUnitsForProductResponse*)[__request createObject:__result type:[getLogisticUnitsForProductResponse class]];
    }
    else
    {
        __res=__requestMgr.OutputFault;
...
-(RequestResultHandler*) getLogisticUnitsForProductAsync:(NSString*) arg0 __target:(id<SoapServiceResponse>) __target
{
    ...
    {
        DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"getLogisticUnitsForProductResponse"];
        [__target onSuccess:(getLogisticUnitsForProductResponse*)[__request createObject:__result type:[getLogisticUnitsForProductResponse class]] methodName:@"getLogisticUnitsForProduct"];
    }
    else
    {
        [__target onError:__requestMgr.OutputFault];
...
-(getLogisticUnitsForProductResponse*) getLogisticUnitsForProduct:(NSString*) arg0 __error:(NSError**) __error
{
    ...
    DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"getLogisticUnitsForProductResponse"];
    return (getLogisticUnitsForProductResponse*)[__request createObject:__result type:[getLogisticUnitsForProductResponse class]];
}
...
{
    DDXMLElement *__methodElement=[__request writeElement:@"getPreparedPrescriptionsCountForPatient" URI:@"http://service/" parent:__request.Body];
    [self addAdornments:__methodElement];
...
{
    RequestResultHandler* __request = [self CreateRequestResultHandler];
    NSMutableURLRequest *__requestObj=[self creategetPreparedPrescriptionsCountForPatientRequest:arg0 __request:__request];
    [self sendImplementation:__requestObj requestMgr:__request callback:^(RequestResultHandler *__requestMgr) {
    id __res;
    if(__requestMgr.OutputFault==nil)
    {
...
-(RequestResultHandler*) getPreparedPrescriptionsCountForPatientAsync:(NSString*) arg0 __target:(id<SoapServiceResponse>) __target
{
    ...
    {
        DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"return"];
        [__target onSuccess:[NSNumber numberWithInt:[[__result stringValue] intValue]] methodName:@"getPreparedPrescriptionsCountForPatient"];
    }
    else
    {
        [__target onError:__requestMgr.OutputFault];
...
-(NSMutableURLRequest*) creategetPreparedPrescriptionsForPatientRequest:(NSString*) arg0 __request:(RequestResultHandler*) __request
{
    DDXMLElement *__methodElement=[__request writeElement:@"getPreparedPrescriptionsForPatient" URI:@"http://service/" parent:__request.Body];
    [self addAdornments:__methodElement];
...
-(RequestResultHandler*) getPreparedPrescriptionsForPatientAsync:(NSString*) arg0 __target:(id) __target __handler:(SEL) __handler
{
    RequestResultHandler* __request = [self CreateRequestResultHandler];
    NSMutableURLRequest *__requestObj=[self creategetPreparedPrescriptionsForPatientRequest:arg0 __request:__request];
    [self sendImplementation:__requestObj requestMgr:__request callback:^(RequestResultHandler *__requestMgr) {
    id __res;
    if(__requestMgr.OutputFault==nil)
    {
        DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"getPreparedPrescriptionsForPatientResponse"];
        __res= (getPreparedPrescriptionsForPatientResponse*)[__request createObject:__result type:[getPreparedPrescriptionsForPatientResponse class]];
    }
    else
    {
        __res=__requestMgr.OutputFault;
...
-(RequestResultHandler*) getPreparedPrescriptionsForPatientAsync:(NSString*) arg0 __target:(id<SoapServiceResponse>) __target
{
    RequestResultHandler* __request = [self CreateRequestResultHandler];
    NSMutableURLRequest *__requestObj=[self creategetPreparedPrescriptionsForPatientRequest:arg0 __request:__request];
    [self sendImplementation:__requestObj requestMgr:__request callback:^(RequestResultHandler *__requestMgr) {
    ...
    {
        DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"getPreparedPrescriptionsForPatientResponse"];
        [__target onSuccess:(getPreparedPrescriptionsForPatientResponse*)[__request createObject:__result type:[getPreparedPrescriptionsForPatientResponse class]] methodName:@"getPreparedPrescriptionsForPatient"];
    }
    else
    {
        [__target onError:__requestMgr.OutputFault];
...
-(getPreparedPrescriptionsForPatientResponse*) getPreparedPrescriptionsForPatient:(NSString*) arg0 __error:(NSError**) __error
{
    RequestResultHandler* __request = [self CreateRequestResultHandler];
    NSMutableURLRequest *__requestObj=[self creategetPreparedPrescriptionsForPatientRequest:arg0 __request:__request];
    [self sendImplementation:__requestObj requestMgr:__request ];
    ...
    DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"getPreparedPrescriptionsForPatientResponse"];
    return (getPreparedPrescriptionsForPatientResponse*)[__request createObject:__result type:[getPreparedPrescriptionsForPatientResponse class]];
}
-(NSMutableURLRequest*) createupdateDispensedMedicationRequest:(trspPrescription*) arg0 arg1:(NSString*) arg1 __request:(RequestResultHandler*) __request
{
    DDXMLElement *__methodElement=[__request writeElement:@"updateDispensedMedication" URI:@"http://service/" parent:__request.Body];
    [self addAdornments:__methodElement];
             
    DDXMLElement* __arg0ItemElement=[__request writeElement:arg0 type:[trspPrescription class] name:@"arg0" URI:@"" parent:__methodElement skipNullProperty:YES];
    if(__arg0ItemElement!=nil)
    {
        [arg0 serialize:__arg0ItemElement __request: __request];
    }
...
-(RequestResultHandler*) updateDispensedMedicationAsync:(trspPrescription*) arg0 arg1:(NSString*) arg1 __target:(id) __target __handler:(SEL) __handler
{
    RequestResultHandler* __request = [self CreateRequestResultHandler];
    NSMutableURLRequest *__requestObj=[self createupdateDispensedMedicationRequest:arg0 arg1: arg1 __request:__request];
    [self sendImplementation:__requestObj requestMgr:__request callback:^(RequestResultHandler *__requestMgr) {
    id __res;
    if(__requestMgr.OutputFault==nil)
    {
        DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"return"];
        __res= (mediPrepResult*)[__request createObject:__result type:[mediPrepResult class]];
    }
    else
    {
        __res=__requestMgr.OutputFault;
...
-(RequestResultHandler*) updateDispensedMedicationAsync:(trspPrescription*) arg0 arg1:(NSString*) arg1 __target:(id<SoapServiceResponse>) __target
{
    RequestResultHandler* __request = [self CreateRequestResultHandler];
    NSMutableURLRequest *__requestObj=[self createupdateDispensedMedicationRequest:arg0 arg1: arg1 __request:__request];
    [self sendImplementation:__requestObj requestMgr:__request callback:^(RequestResultHandler *__requestMgr) {
    ...
    {
        DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"return"];
        [__target onSuccess:(mediPrepResult*)[__request createObject:__result type:[mediPrepResult class]] methodName:@"updateDispensedMedication"];
    }
    else
    {
        [__target onError:__requestMgr.OutputFault];
...
-(mediPrepResult*) updateDispensedMedication:(trspPrescription*) arg0 arg1:(NSString*) arg1 __error:(NSError**) __error
{
    RequestResultHandler* __request = [self CreateRequestResultHandler];
    NSMutableURLRequest *__requestObj=[self createupdateDispensedMedicationRequest:arg0 arg1: arg1 __request:__request];
    [self sendImplementation:__requestObj requestMgr:__request ];
    ...
    DDXMLElement *__result=[Helper getResultElement:__request.OutputBody name:@"return"];
    return (mediPrepResult*)[__request createObject:__result type:[mediPrepResult class]];
}
