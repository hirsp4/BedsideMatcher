...
@interface getOpenOrdersByGLN : NSObject <ISerializableObject>
...
+(getOpenOrdersByGLN*) createWithXml:(DDXMLElement*)__node __request:(RequestResultHandler*) __request;
